...
type NnwdafEventsSubscription struct {
	...
	// NotifCorrId - "Notification correlation identifier."
	//
	// Defined by TS 29.520 in the NnwdafEventsSubscription schema and required
	// by TS 23.288 clause 6.1.3, which lists the consumer input as "a
	// Notification Target Address (+ Notification Correlation ID) ... allowing
	// to correlate notifications received from NWDAF with this subscription".
	// It was MISSING from the generated model entirely, so a consumer running
	// more than one subscription could not route incoming notifications.
