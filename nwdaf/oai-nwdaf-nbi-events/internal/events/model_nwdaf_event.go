...
const (
	...
	// NWDAFEVENT_TRAFFIC_STEERING_UPF_LOAD is a custom (non-3GPP) analytic ID: AI-driven
	...
	NWDAFEVENT_TRAFFIC_STEERING_UPF_LOAD NwdafEvent = "TRAFFIC_STEERING_UPF_LOAD"
)
