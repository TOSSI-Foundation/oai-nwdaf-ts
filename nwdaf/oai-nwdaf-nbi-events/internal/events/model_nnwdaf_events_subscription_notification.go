...
type NnwdafEventsSubscriptionNotification struct {
	...
	// NotifCorrId - echoed back from the subscription so the consumer can
	// correlate this notification with it (TS 29.520 NnwdafEventsSubscription-
	// Notification schema; TS 23.288 clause 6.1.3).
